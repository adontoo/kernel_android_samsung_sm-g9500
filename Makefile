...
CROSS_COMPILE = /home/adontoo/android/build-tools/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
REAL_CC        = $(srctree)/tools/prebuilts/gcc-cfp/gcc-cfp-single/aarch64-linux-android-4.9/bin/aarch64-linux-android-gcc
CC		= $(srctree)/scripts/gcc-wrapper.py $(REAL_CC)
endif
# check for 'asm goto'
