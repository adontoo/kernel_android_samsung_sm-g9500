...
1. How to Build
        ...
        - to Build
                $ export ARCH=arm64
                $ make -C $(pwd) O=$(pwd)/out KCFLAGS=-mno-android dreamqlte_usa_open_defconfig
...
3. How to Clean
        ...
        EX) /home/dpi/qb5_8814/workspace/P4_1716/android/out/target/product/dreamqlteue/out
        $ make clean
################################################################################
